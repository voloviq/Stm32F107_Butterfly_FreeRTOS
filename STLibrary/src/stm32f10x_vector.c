...
//xxxvoid SVCHandler(void);
void vPortSVCHandler( void ) __attribute__((naked));
//xxxvoid PendSVC(void);
...
// M.Wolowik Following declaration nowhere used so was commented
//xxx extern unsigned long _etext;

extern unsigned long _sidata;		/* start address for the initialisation values
...
extern void const _estack;		/* init value for the stack pointer. defined in linker script */
